...
export const insertSampleData = async () => {
  ...
  const sampleUsers = [
    { id: 'ADMIN001', name: 'John Smith', role: 'hospital_administrator', email: 'admin@hospital.com' },
    { id: 'ADMIN002', name: 'Sarah Johnson', role: 'hospital_administrator', email: 'admin2@hospital.com' },
    { id: 'ADMIN003', name: 'Mike Davis', role: 'hospital_administrator', email: 'admin3@hospital.com' },
    { id: 'SUPPLY001', name: 'Lisa Wilson', role: 'supply_chain_officer', email: 'supply@hospital.com' },
    { id: 'SUPPLY002', name: 'Tom Brown', role: 'supply_chain_officer', email: 'supply2@hospital.com' },
    { id: 'SUPPLY003', name: 'Emma Garcia', role: 'supply_chain_officer', email: 'supply3@hospital.com' },
    { id: 'PHARM001', name: 'Dr. Robert Lee', role: 'pharmacist', email: 'pharm@hospital.com' },
    { id: 'PHARM002', name: 'Nurse Jane Doe', role: 'nurse', email: 'nurse@hospital.com' },
    { id: 'PHARM003', name: 'Dr. Maria Rodriguez', role: 'pharmacist', email: 'pharm2@hospital.com' },
  ]
